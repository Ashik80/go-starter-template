class TodoDetail extends HTMLElement {
  constructor() {
    ...
    this.removeEventListeners = this.cleanupEventListeners.bind(this);
  ...
  cleanupEventListeners() {
    ...
    this.cancelButton.removeEventListener("click", this.hideFormAndShowDetails);
  }
  ...
  disconnectedCallback() {
    ...
    this.editForm.removeEventListener("htmx:afterSwap", this.reinitializeForm);
  }
}
